...
const ContextWindow = () => {
  ...
  const renderWithCode = s => s.split('`').map((part, i) => i % 2 === 1 ? /*#__PURE__*/React.createElement("code", {
    key: i,
    style: {
      fontFamily: mono,
      fontSize: '0.92em',
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "cw-mobile-fallback"
  }, "This interactive timeline works best on a larger screen. See ", /*#__PURE__*/React.createElement("a", {
    href: "#what-the-timeline-shows",
    style: {
      color: '#D97757'
    }
  }, "the written breakdown below"), " for the same concepts."), /*#__PURE__*/React.createElement("div", {
    className: "cw-root",
    ref: rootRef,
  ...
  }, "Explore the context window"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 14,
      color: 'var(--cw-text-dim)',
      marginTop: 4
    }
  }, "A simulated session showing what enters context and what it costs")), /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'right',
      flexShrink: 0
    }
  ...
  }, "~", fmt(totalTokens), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 15,
      fontWeight: 500,
      marginLeft: 4
  ...
  }, "/ ", fmt(MAX), " · illustrative"))), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '0 20px'
    }
  }, /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("div", {
      key: b.id,
      onMouseEnter: () => setHovIdx(b.visIdx),
      onMouseLeave: () => setHovIdx(null),
      onClick: () => setSelIdx(selIdx === b.visIdx ? null : b.visIdx),
      style: {
        width: w + '%',
        height: '100%',
        background: b.color,
    ...
    cy: "12",
    r: "3"
  })), /*#__PURE__*/React.createElement("span", null, "= appears in your terminal")))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      padding: '14px 20px 0',
      gap: 16,
  ...
  }, visible.length === 0 && !playing && /*#__PURE__*/React.createElement("div", {
    style: {
      height: '100%',
      display: 'flex',
      flexDirection: 'column',
  ...
  }, "$"), /*#__PURE__*/React.createElement("span", null, "claude"), /*#__PURE__*/React.createElement("span", {
    style: {
  ...
  }, /*#__PURE__*/React.createElement("span", null, "▶"), /*#__PURE__*/React.createElement("span", null, "Start session")), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: 'var(--cw-text-faint)',
      maxWidth: 280,
  ...
  }, "Watch what loads into context, from the moment you run ", /*#__PURE__*/React.createElement("code", {
    style: {
      fontFamily: mono
    }
  }, "claude"), " through a full conversation.")), isCompacted && /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 10,
      padding: '10px 12px',
      borderRadius: 6,
  ...
  }, "After /compact"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: 'var(--cw-text-3)',
      lineHeight: 1.5,
  ...
  }, fmt(preCompactTotal), " → ", fmt(totalTokens), " tokens · freed ", fmt(preCompactTotal - totalTokens)), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: 'var(--cw-text-dim)',
      lineHeight: 1.5,
  ...
  }, isCompacted ? 'Reloaded after compact' : 'Before you type anything'), time > 0 && visible.map((evt, i) => {
    ...
    return /*#__PURE__*/React.createElement("div", {
      key: evt.label + evt.t,
      className: isNewRow ? 'cw-compacted-row' : '',
      style: isNewRow ? {
        animationDelay: `${i * 60}ms`
      } : {}
    }, showPhase && /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        fontWeight: 700,
        color: 'var(--cw-text-faint)',
    ...
    }, showPhase), enteringSubagent && /*#__PURE__*/React.createElement("div", {
      style: {
        marginLeft: 28,
        marginTop: 6,
        marginBottom: 2,
    ...
    }, "Subagent's separate context window"), leavingSubagent && /*#__PURE__*/React.createElement("div", {
      style: {
        marginLeft: 28,
        marginBottom: 6,
        paddingLeft: 10,
    ...
    }, "↓ ", fmt(subTotal), " tokens stayed in subagent's context · only the summary returns"), /*#__PURE__*/React.createElement("div", {
    ...
    }), i < visible.length - 1 && /*#__PURE__*/React.createElement("div", {
      style: {
        width: 1.5,
        flex: 1,
    ...
    }, evt.label), evt.tokens > 0 && /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 12,
        fontFamily: mono,
        color: 'var(--cw-text-faint)',
    ...
    }, "+", fmt(evt.tokens)), evt.subTokens > 0 && /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 12,
        fontFamily: mono,
        color: '#9B7BC4',
    ...
    }, "+", fmt(evt.subTokens)), evt.tokens > 0 && /*#__PURE__*/React.createElement("div", {
      style: {
        width: 50,
        height: 5,
        borderRadius: 2,
    ...
    }, evt.vis !== 'hidden' && /*#__PURE__*/React.createElement("svg", {
      width: "12",
      height: "12",
      viewBox: "0 0 24 24",
      fill: "none",
      stroke: evt.vis === 'full' ? '#558A42' : 'currentColor',
      style: {
        color: 'var(--cw-text-faint)',
  ...
  }), activeGate && (activeGate.kind === 'prompt' || activeGate.kind === 'bang' || activeGate.kind === 'slash') && /*#__PURE__*/React.createElement("div", {
    style: {
      paddingLeft: 28,
      marginTop: 12,
      paddingRight: 8
  ...
  }, "You type in your terminal"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'flex-start',
      gap: 8,
  ...
  }, activeGate.text, /*#__PURE__*/React.createElement("span", {
    style: {
      display: 'inline-block',
      width: 7,
      height: 13,
  ...
  }, activeGate.kind === 'prompt' ? 'Send ↵' : 'Run ↵'))), activeGate && activeGate.kind === 'compact' && /*#__PURE__*/React.createElement("div", {
    style: {
      paddingLeft: 28,
      marginTop: 12,
      paddingRight: 8
  ...
  }, "Context is at ", /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: mono,
      fontWeight: 600,
      color: barColor
    }
  }, fmt(totalTokens), " tokens"), ". Run ", /*#__PURE__*/React.createElement("code", {
    style: {
      fontFamily: mono,
      background: 'var(--cw-track)',
      padding: '1px 4px',
  ...
  }, "/compact"), " to summarize older exchanges and free space for more work."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 8
  ...
  }, activeGate.text), /*#__PURE__*/React.createElement("button", {
    onClick: sendPrompt,
    style: {
      padding: '5px 12px',
      borderRadius: 5,
  ...
  }, hovEvent ? /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 8,
  ...
  }, hovEvent.label)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      width: 'fit-content',
      padding: '3px 8px',
  ...
  }, KIND_META[hovEvent.kind].detail)), hovEvent.tokens > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 14,
      fontFamily: mono,
      color: 'var(--cw-text-dim)',
  ...
  }, fmt(hovEvent.tokens), " tokens"), hovEvent.subTokens > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 14,
      fontFamily: mono,
      color: '#9B7BC4',
  ...
  }, fmt(hovEvent.subTokens), " tokens in the subagent's context"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 15,
      color: 'var(--cw-text-3)',
      lineHeight: 1.55,
  ...
  }, renderWithCode(hovEvent.desc)), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 10,
      padding: '8px 10px',
      borderRadius: 6,
  ...
  }, hovEvent.vis === 'full' ? '●' : hovEvent.vis === 'brief' ? '◐' : '○'), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 12,
      fontWeight: 600,
      color: 'var(--cw-text-2)'
    }
  }, VIS_META[hovEvent.vis].label)), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: 'var(--cw-text-dim)',
      lineHeight: 1.4
    }
  }, VIS_META[hovEvent.vis].sub)), hovEvent.tip && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 10,
      padding: '8px 10px',
      borderRadius: 6,
  ...
  }, /*#__PURE__*/React.createElement("span", null, "💡"), " Save context"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: 'var(--cw-text-3)',
      lineHeight: 1.5
    }
  }, renderWithCode(hovEvent.tip))), hovEvent.link && /*#__PURE__*/React.createElement("a", {
    href: hovEvent.link,
    style: {
      display: 'inline-block',
      marginTop: 10,
  ...
  }, "Hover or click any event"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: 'var(--cw-text-faint)',
      lineHeight: 1.4,
  ...
  }, "Hover to preview. Click to pin so you can scroll.")), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '10px 12px',
      borderRadius: 8,
      background: 'rgba(217,119,87,0.05)',
  ...
  }, "In your terminal you see"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: 'var(--cw-text-3)',
      lineHeight: 1.5
    }
  }, terminalView))))), /*#__PURE__*/React.createElement("div", {
    style: {
    ...
    "aria-label": time >= 1 ? 'Restart' : activeGate ? 'Continue' : playing ? 'Pause' : 'Play',
    onClick: () => {
      if (time >= 1) {
        setTime(0);
        setGatesPassed(0);
  ...
  }, time >= 1 ? '↺' : playing ? '⏸' : '▶'), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
      height: 3,
      borderRadius: 2,
  ...
  }, Math.round(time * 100), "%"), /*#__PURE__*/React.createElement("button", {
...
window.ContextWindow = ContextWindow;ReactDOM.createRoot(document.getElementById('root')).render(React.createElement(ContextWindow));
